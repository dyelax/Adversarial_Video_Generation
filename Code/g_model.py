...
class GeneratorModel:
                ...
                with tf.name_scope('scale_' + str(scale_num)):
                    with tf.name_scope('setup'):
                        ...
                        for i in xrange(len(self.scale_kernel_sizes[scale_num])):
                            self.ws.append(w([self.scale_kernel_sizes[scale_num][i],
                                              self.scale_kernel_sizes[scale_num][i],
                                              self.scale_layer_fms[scale_num][i],
                                              self.scale_layer_fms[scale_num][i + 1]]))
                            self.bs.append(b([self.scale_layer_fms[scale_num][i + 1]]))

                        # add to trainable parameters
                        self.train_vars += self.ws
                        self.train_vars += self.bs
    ...
    def generate_predictions(self, scale_num, height, width, inputs, gts, last_gen_frames):
        """
        ...
        @return: The generated frames. A tensor of shape
                                       [batch_size x scale_height x scale_width x 3]
        """
        ...
        if last_gen_frames is not None:
            last_gen_frames = tf.image.resize_images(last_gen_frames, scale_height, scale_width)
